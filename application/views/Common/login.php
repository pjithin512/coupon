            ...
            <div class="col-lg-3  pr-0">
                <div class="card mb-0 shadow-none">
                    <div class="card-body">
                        ...
                        <div class="px-3">
                            <div class="media">
                                <a href="index.html" class="logo logo-admin"><img src="<?= base_url();?>assets/images/logo-sm.png" height="55" alt="logo" class="my-3"></a>
                            ...
                            <form class="form-horizontal my-4" action="index.html">
                                ...
                                <div class="form-group mb-0 row">
                                    ...
                                    <a href="<?= base_url();?>dashboard" class="btn btn-primary btn-block waves-effect waves-light" >Log In <i class="fas fa-sign-in-alt ml-1"></i></a>
                                    </div>
                                </div>                            
                            </form>
                        </div>
